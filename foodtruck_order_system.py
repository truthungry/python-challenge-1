...
#         # Get the customer selection
#         menu_selection = input("Select an item by number, or type 'exit' to quit: ").strip()
...
#         if not menu_selection.isdigit in menu:
#             print(f"\nYou selected:", menu_selection)
#             print(f"\nHere are the items available:", )
#         # Validate if the chosen category is a number
        
    
#         # Get the category and item selection
#         category_keys = list(menu.keys())
#         try:
#             category = category_keys[int(menu_selection) - 1]
...
#         if item_selection not in menu:{category} or 
...
#             "price": menu[category][item_selection],
#             "quantity": quantity
#         }
#         order_list.append(order)
